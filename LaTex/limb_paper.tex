...
We suggest that it may be possible to use limb darkening across Titan's disk at wavelengths with differing degrees of gaseous absorption to probe haze properties as a function of altitude.  In this paper, we report observed limb darkening or limb brightening parameters for Titan's haze throughout the Cassini mission, leaving detailed analysis and modeling for future efforts.  We discuss the observations that we analyze from the VIMS instrument in Section 2, \ldots
