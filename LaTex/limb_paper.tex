...
Cassini employed a few different techniques that isolate the haze's vertical structure.  The Imaging Science Subsystem (ISS) instrument, a fine-resolution visible-light camera, could optically identify and measure haze profiles along Titan's limb.  In particular, ISS was able to monitor conditions of the ``detached haze" --- a thin, discrete high-altitude layer of haze enhancement first seen by Voyager 1 \citep{}.  \citet{2009Icar..201..626L} were able to constrain properties of the aerosol particles within a particular detached haze layer.  The haze dropped sharply in altitude from $\sim500$~km down to $\sim370$~km at the time of Titan's northern spring equinox in 2008 \citep{west2011evolution}.  The detached haze later disappeared in 2012 and reappeared later in 2016 \cite{2018NatAs...2..495W}.

The other technique that reveals vertical structure uses occultations.  When a star, or the Sun, passes behind the limb of Titan as viewed from Cassini, the spectral lightcurve of the occultation depends on vertical atmospheric variations.  VIMS observed a set of 14 relevant occultations \citep{2016DPS....4851508S}
