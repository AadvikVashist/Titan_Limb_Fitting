...
\subsection{SRTC++} 
% TODO: Jason/Gabe to write this - explain the assumptions, model parameters, how SRTC++ works, what drove the choice of parameters, how we validated the model.
...
%TODO: Aadvik - takl about using only lower wavelenght - as accuract was super low- degradiation in the VIMS-IR data was significant. 
...
% TODO: Aadvik - Trust mapping - do mean/std instead of std/mean FIGURE HERE, and do the writeup as well
\subsection{Quadratic Limb Darkening Law Regression}
%TODO: Aadvik - reference quad figures here - we should show the transects themselves, and how the fits are generally effective
...
% TODO: Group - New name for this section
\subsection{Compiled Analysis} 
% TOOD: Aadvik - writeup here - combining the vims and srtc++ data. 
